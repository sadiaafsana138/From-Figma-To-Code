...
Several projects were designed in **Figma** before being coded. The original `.fig` design files and PDF mockups are included inside the relevant project folders:

- Gamer Zone — desktop + mobile Figma design included
...
These projects reflect a clear learning journey:

| Stage | Projects | What Changed |
|---|---|---|
